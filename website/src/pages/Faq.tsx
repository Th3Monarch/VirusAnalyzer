...
const faqs: FaqItem[] = [
  {
    question: { en: "What is Prometeo?", es: "¿Qué es Prometeo?" },
    answer: {
      en: "Prometeo is a Windows desktop application for malware analysis and threat assessment. It performs static analysis of suspicious files and folders, computes hashes, applies an explainable heuristic engine and optionally checks reputation on VirusTotal by hash.",
      es: "Prometeo es una aplicación de escritorio para Windows de análisis de malware y evaluación de amenazas. Realiza un análisis estático de archivos y carpetas sospechosos, calcula hashes, aplica un motor heurístico explicable y opcionalmente consulta la reputación en VirusTotal por hash.",
    },
  },
  {
    question: { en: "Is Prometeo an antivirus?", es: "¿Es Prometeo un antivirus?" },
    answer: {
      en: "No. Prometeo is an analysis and threat assessment tool, not a real-time antivirus. It does not offer real-time protection, automatic blocking or scheduled scanning, and it is not a replacement for a professional endpoint security solution.",
      es: "No. Prometeo es una herramienta de análisis y evaluación de amenazas, no un antivirus en tiempo real. No ofrece protección en tiempo real, bloqueo automático ni análisis programados, y no sustituye a una solución profesional de seguridad de endpoints.",
    },
  },
  {
    question: { en: "Does Prometeo execute suspicious files?", es: "¿Ejecuta Prometeo archivos sospechosos?" },
    answer: {
      en: "No. Analysis is static: Prometeo inspects the file (type, entropy, PE structure, imports, strings) without executing its contents. It never runs the file it is analyzing, and it provides no sandbox or dynamic analysis.",
      es: "No. El análisis es estático: Prometeo inspecciona el archivo (tipo, entropía, estructura PE, imports, cadenas) sin ejecutar su contenido. Nunca ejecuta el archivo que está analizando y no ofrece sandbox ni análisis dinámico.",
    },
  },
  {
    question: { en: "Does Prometeo upload my files?", es: "¿Sube Prometeo mis archivos?" },
    answer: {
  ...
  {
    question: { en: "Can I use Prometeo without VirusTotal?", es: "¿Puedo usar Prometeo sin VirusTotal?" },
    answer: {
  ...
  {
    question: { en: "Is Prometeo free?", es: "¿Es gratis Prometeo?" },
    answer: {
  ...
  },
  {
    ...
    answer: {
      en: "Newly compiled or unsigned Windows executables can be flagged by heuristic machine-learning detections, even when they are benign. Prometeo does not use obfuscation, packing or evasion techniques. Verify the SHA-256 checksum against the published release before running it.",
      es: "Los ejecutables de Windows recién compilados o sin firmar pueden marcarse con detecciones heurísticas de aprendizaje automático, incluso cuando son benignos. Prometeo no usa ofuscación, empaquetado ni técnicas de evasión. Verifica el checksum SHA-256 contra la versión publicada antes de ejecutarlo.",
    },
  },
  {
